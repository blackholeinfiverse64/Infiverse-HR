...
export default function ClientJobsMonitor() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Header */}
      <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-500/5 to-indigo-500/5 dark:from-blue-500/10 dark:to-indigo-500/10 backdrop-blur-xl border border-blue-300/20 dark:border-blue-500/20">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="page-title">Live Client Monitoring</h1>
            <p className="text-gray-600 dark:text-gray-400">Real-time view of jobs posted by clients in your organization</p>
          </div>
          <button
            onClick={loadJobs}
